...
#
# This file is part of SevereInHospitalizedPatients
#
...
OhdsiRTools::checkUsagePackage("SevereInHospitalizedPatients")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SevereInHospitalizedPatients.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SevereInHospitalizedPatients.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "SevereInHospitalizedPatients")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SevereInHospitalizedPatients")

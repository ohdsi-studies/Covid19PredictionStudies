...
OhdsiRTools::checkUsagePackage("HospitalizationInSymptomaticPatientsValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/HospitalizationInSymptomaticPatientsValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HospitalizationInSymptomaticPatientsValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "HospitalizationInSymptomaticPatientsValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("HospitalizationInSymptomaticPatientsValidation")

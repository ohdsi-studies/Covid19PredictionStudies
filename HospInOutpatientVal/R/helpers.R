...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "HospInOutpatientVal")
...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "HospInOutpatientVal",
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "HospInOutpatientVal")
  if(pathToCustom!=""){

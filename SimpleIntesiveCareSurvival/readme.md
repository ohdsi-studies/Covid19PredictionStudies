A Package For Developing A Simple Model Predicting Short-term and Long-term survivial after intensive care for pneumonia and ARDS
========================================================
...
```r
  ...
  devtools::install_github("ohdsi-studies/Covid19PredictionStudies/SimpleIntesiveCareSurvival")
```
...
```r
  library(SimpleIntesiveCareSurvival)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./SimpleIntesiveCareSurvivalResults"
...
cohortTable <- 'SimpleIntesiveCareSurvivalCohort'
#=======================

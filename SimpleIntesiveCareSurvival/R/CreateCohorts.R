...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "SimpleIntensiveCareSurvival",
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "SimpleIntensiveCareSurvival")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", cohortVariableSetting, package = "SimpleIntensiveCareSurvival")

...
#
# This file is part of SimpleIntensiveCareSurvival
#
...
#'
#' @details
#' This function executes the SimpleHospitalizationInFluPatients Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if(runDiagnostic){
    ...
    predictionAnalysisListFile <- system.file("settings",
                                              ...
                                              package = "SimpleIntensiveCareSurvival")

...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "HospInOutpatientValidation")
...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "HospInOutpatientValidation",
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "HospInOutpatientValidation")
  if(pathToCustom!=""){

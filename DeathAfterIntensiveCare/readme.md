A Package For Developing Models That Prediction Who Will Survive Short-term and Long-term After Intensive Care For Pneumonia and ARDS
========================================================
...
```r
  ...
  devtools::install_github("ohdsi-studies/Covid19PredictionStudies/DeathAfterIntensiveCare")
```

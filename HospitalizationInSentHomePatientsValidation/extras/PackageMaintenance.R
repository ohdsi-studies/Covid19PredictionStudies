...
OhdsiRTools::checkUsagePackage("HospitalizationInSentHomePatientsValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/HospitalizationInSentHomePatientsValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HospitalizationInSentHomePatientsValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "HospitalizationInSentHomePatientsValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("HospitalizationInSentHomePatientsValidation")

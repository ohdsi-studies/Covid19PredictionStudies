...
Technology
==========
  HospitalizationInSentHomePatientsValidation is an R package.
...
Guide
============
A general guide for running a valdiation study package is available here: [Skeleton Validation Study guide](https://github.com/OHDSI/HospitalizationInSentHomePatientsValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf)
...
===============
  ...
  2. In R, run the code in 'extras/codeToRun.R' (see [Skeleton Validation Study guide](https://github.com/OHDSI/HospitalizationInSentHomePatientsValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf) for guideance)


C. Example Code
===============
```r
library(HospitalizationInSentHomePatientsValidation)
...
cohortTable <- 'HospitalizationInSentHomePatientsValidationCohortTable'
...
# Now run the study:
HospitalizationInSentHomePatientsValidation::execute(connectionDetails = connectionDetails,
...
License
=======
  HospitalizationInSentHomePatientsValidation is licensed under Apache License 2.0

Development
===========
  HospitalizationInSentHomePatientsValidation is being developed in R Studio.

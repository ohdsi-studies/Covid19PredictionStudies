...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "HospitalizationInSymptomaticPatientsValidation")
...
.createCohorts <- function(connection,
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "HospitalizationInSymptomaticPatientsValidation")
  if(pathToCustom!=""){

...
\NormalTok{devtools}\OperatorTok{::}\KeywordTok{install_github}\NormalTok{(}\StringTok{"OHDSI-studies/HospitalizationInSymptomaticPatientsValidation"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(HospitalizationInSymptomaticPatientsValidation)}
\NormalTok{?execute}
\end{Highlighting}
\end{Shaded}

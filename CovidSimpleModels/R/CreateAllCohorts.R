...
#' @param usePackageCohorts    Use package T and O or supply new T and O details
#' @param newTargetCohortId    New cohort definition id for T
#' @param newOutcomeCohortId   New cohort definition id for O
#' @param newCohortDatabaseSchema database schema containing the new T and O
#' @param newCohortTable       cohort table containing the new T and O
